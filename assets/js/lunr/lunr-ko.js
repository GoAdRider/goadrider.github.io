...
document.addEventListener('DOMContentLoaded', function () {
    if (DEBUG_MODE) console.log('한국어 검색 엔진 초기화');
...
function buildSearchIndex() {
    ...
    if (DEBUG_MODE) console.log('한국어 검색 인덱스 구축 시작');
    ...
    setTimeout(function () {
        try {
            ...
            if (DEBUG_MODE) console.log('한국어 검색 인덱스 구축 완료 (' + (endTime - startTime).toFixed(0) + 'ms)');
